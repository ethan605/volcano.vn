<?php /* Smarty version 2.6.0, created on 2014-02-25 22:40:04
...
<div id="content">
  <h2><img src="images/icons/tools_32.png" alt="Manage News" />Manage Server Details</h2>
...
<input type="hidden" name="keyname" value="">
  ...
  <div class="content-box column-left sidebar">
    ...
    <div class="content-box-content" style="height:auto;">
        <select name="option">
          <option value="server_link">Station Link </option>
                    <option value="radio_no">Radio No</option>
          <option value="radio_station_email">Radio Station Mail</option>
      ...
      <br />
      <ul>
        <li><a href="memberView.php">View Station Details</a></li>
        <li><a href="memberAdd.php">Add Station Details</a></li>
      </ul>
    </div>
  </div>
